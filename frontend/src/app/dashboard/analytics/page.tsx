...
const stats = [
  { label: "Total Games", value: "147", icon: "sports_esports", trend: "+12 this week" },
  { label: "Win Rate", value: "76%", icon: "trending_up", trend: "+4% vs last month" },
  { label: "Avg KDA", value: "8.2", icon: "auto_awesome", trend: "Excellent" },
  { label: "LP Gained", value: "+842", icon: "arrow_upward", trend: "Since order start" },
];

const matchHistory = [
  { champ: "Lee Sin", result: "Victory", kda: "12/2/8", cs: "187", duration: "18:24", lp: "+28" },
  { champ: "Kha'Zix", result: "Victory", kda: "8/1/4", cs: "156", duration: "24:51", lp: "+26" },
  { champ: "Nidalee", result: "Defeat", kda: "4/5/12", cs: "143", duration: "32:10", lp: "-18" },
  { champ: "Lee Sin", result: "Victory", kda: "15/3/7", cs: "201", duration: "21:33", lp: "+29" },
  { champ: "Elise", result: "Victory", kda: "9/2/11", cs: "134", duration: "26:45", lp: "+25" },
];
  ...
  return (
    <>
      <header className="sticky top-0 z-30 flex items-center justify-between px-8 py-4 bg-bg-primary/60 backdrop-blur-md border-b border-white/5">
        <h2 className="text-xl font-bold">Match Analytics</h2>
            ...
            <table className="w-full">
              <thead>
                <tr className="text-xs text-white/40 uppercase tracking-wider">
                  <th className="px-6 py-3 text-left font-bold">Champion</th>
                  ...
                  <th className="px-6 py-3 text-left font-bold">LP</th>
                </tr>
              </thead>
              <tbody>
                    ...
                    <td className="px-6 py-4">
                      <span
                        className={`text-sm font-bold ${
                          m.result === "Victory" ? "text-green-400" : "text-red-400"
                        }`}
                      >
                        {m.result}
                      </span>
